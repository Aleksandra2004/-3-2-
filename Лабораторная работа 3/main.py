...
print(paper_book)  # Книга 1984. Автор Джордж Оруэлл, Страниц: 328
print(repr(paper_book))  # PaperBook(name='1984', author='Джордж Оруэлл', pages=328)

print(audio_book)  # Книга Гарри Поттер и философский камень. Автор Джоан Роулинг, Длительность: 8.50 часов
print(repr(audio_book))  # AudioBook(name='Гарри Поттер и философский камень', author='Джоан Роулинг', duration=8.5)
